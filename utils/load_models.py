...
def create_centroid_wordlist(model, wordlist):

    matrix = []

    for w in wordlist:
        vec = represent(model, w)
        if vec != 'OOV':
            matrix.append(vec)
...
def main():
    ...
    #path_hyp_sgns = '/Users/piasommerauer/Data/dsm/my_models/models/sgns_pinit1/sgns_rand_pinit1'
